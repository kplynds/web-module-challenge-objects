...
function createMenuItem(name, cost, category){
  const newItem = {name: name, price: cost, category: category}
  return newItem
}


/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */
function createMenuItem("Pizza", 12, "Lunch");
function createMenuItem("Salad", 10, "Lunch");
function createManuItem("Flum", 24, "Drinks"); 
...
reviews.push({name: "Kyle", rating: 4.20, feedback: "Like the moon: foods' great, atmospheres' terrible."}) 
